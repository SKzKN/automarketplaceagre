...
class VeegoScraper(AiohttpScraper):
    ...
    async def get_listings_make_series_model(self, make_series_model: tuple[str, str | None, str], max_pages: Optional[int] = 10) -> list[tuple[str, tuple[str, str | None, str]]]:
        listing_urls = set()
    ...
    async def process_get_listings_make_series_model_batch(self, make_series_models: List[tuple[str, str | None, str]], max_pages: Optional[int] = 10) -> List[tuple[str, tuple[str, str | None, str]]]:
